...
targets <- construct.targets(selected.stratifications)
```

***
<br>

### Control Validation Data by Variant Annotation

```{r report.toplevel.table, eval=TRUE, echo=FALSE, results="asis", fig.width=10}
...
##
# targets <- c("All available variants" = "*",
#             "All difficult regions" = "alldifficultregions")
for (i in seq_len(length(targets))) {
  cat("\n\n####", names(targets)[i], "\n\n")
  print(make.plot(plot.data, c("SNP", "INDEL"), targets[i]))
  cat("\n\n***\n<br>\n\n")
}
```
